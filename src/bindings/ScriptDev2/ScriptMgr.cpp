...
extern void AddSC_mob_coilfang_guardian();
extern void AddSC_mob_coilfang_ambusher();
...
void ScriptsInit()
{
    ...
    AddSC_mob_coilfang_guardian();
    AddSC_mob_coilfang_ambusher();
